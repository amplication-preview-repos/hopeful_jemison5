...
@InputType()
class TransactionUpdateManyWithoutCryptoWalletsInput {
...
export { TransactionUpdateManyWithoutCryptoWalletsInput as TransactionUpdateManyWithoutCryptoWalletsInput };
