...
import { CryptoWallet } from "../../cryptoWallet/base/CryptoWallet";
...
export class TransactionResolverBase {
  ...
  async createTransaction(
    ...
    return await this.service.createTransaction({
      ...
      data: {
        ...
        cryptoWallet: args.data.cryptoWallet
          ? {
              connect: args.data.cryptoWallet,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => CryptoWallet, {
    nullable: true,
    name: "cryptoWallet",
  })
  @nestAccessControl.UseRoles({
  ...
  async getCryptoWallet(
    ...
    const result = await this.service.getCryptoWallet(parent.id);
